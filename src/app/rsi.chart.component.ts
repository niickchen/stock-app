...
@Component({
    ...
    template: `<div style="width:100%; height:80%;" id="rsi-container"></div>`
})

export class RSIChartComponent implements AfterViewInit { 
    @Input() dates: string[];
    @Input() data: any[];
    @Input() symbol: string;
    ...
    renderChart() {
        ...
        Highcharts.chart('rsi-container', options);
